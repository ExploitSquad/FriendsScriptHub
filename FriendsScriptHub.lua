...
local Scripts = Tab:NewSection("Scripts")
local Tab = Window:NewTab("FEScripts")
local FEScripts = Tab:NewSection("FEScripts")
local Tab = Window:NewTab("FEAnimations")
local FEAnimations = Tab:NewSection("FEAnimations")
local Tab = Window:NewTab("DH")
local dhmdh = Tab:NewSection("DH")
local Tab = Window:NewTab("Settings")
local Settings = Tab:NewSection("Settings")
Scripts:NewButton("Infinity Yielder", "", function()
    loadstring(game:HttpGet("https://cdn.wearedevs.net/scripts/Infinite%20Yield.txt"))()
end)

dhmdh:NewButton("Softvex", "", function()
    loadstring(game:HttpGet(("https://raw.githubusercontent.com/Airsoft0001/69/main/69"),true))()
end)
dhmdh:NewButton("chariosware", "", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Rippeed/DaHoodinary/main/chariotsware"))()
end)
Settings:NewKeybind("Toggle", "", Enum.KeyCode.F, function()
	Library:ToggleUI()
end)

FEAnimations:NewButton("tryhard animation", "", function()
local Animate = game.Players.LocalPlayer.Character.Animate
    ...
    Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=754636589"
    game.Players.LocalPlayer.Character.Humanoid.Jump = true
end)

Scripts:NewButton("HitBox", "", function()
    loadstring(game:HttpGet("http://gameovers.net/Scripts/Free/HitboxExpander/main.lua", true))()
end)

FEScripts:NewButton("Xorden FE", "ButtonInfo", function()
